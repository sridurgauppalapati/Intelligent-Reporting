...
public class EAAppLocators {
 ...
 static {
     // Login Page
     LOCATORS.put("LoginLink", "//a[@id='loginLinkr']");
     DESCRIPTIONS.put("LoginLink", "Login navigation link in header");
     
     LOCATORS.put("UserName", "//input[@id='UserName1']");
     ...
     // New locator for data rows only (excluding header)
     LOCATORS.put("EmployeeTableDataRows", "//table[@class='table']//tbody/tr[position() > 1]");
     DESCRIPTIONS.put("EmployeeTableDataRows", "Only data rows in the employee table (excluding header row)");
    ...
    //  LOCATORS.put("BenefitsEmployeeName", "//h2[contains(text(),'Benefits')]");
